...
static yyconst short int yy_base[22] =
    {   0,
        0,    0,   21,    0,    7,   22,   16,   11,   22,   11,
        0,    0,   22,   13,   22,    0,    8,    0,   22,   11,
       13
    } ;

static yyconst short int yy_def[22] =
    {   0,
       19,    1,   19,   20,   20,   19,   21,   20,   19,    8,
       20,    5,   19,   21,   19,   10,   20,   17,    0,   19,
       19
    } ;
...
YY_RULE_SETUP
#line 56 "mojssp.l"
{dodajUniformni("KON   ",brKON++);dodajKON(yytext);}
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 59 "mojssp.l"
